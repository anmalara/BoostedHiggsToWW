...
void DisplayCutFlow(string outdir = "../file/outputfile/part/", bool quick = true) {
    ...
    bool cut_norm = true;
    TH1F* histo_cut_signal = CutFlow(file_name_signal, name_dir, "signal", cut_norm, 0.752);
    ...
    TCanvas *c;
    if(quick) name_histo = {"boostedJet_angular_sel/SDmass_jet1"};
/*
