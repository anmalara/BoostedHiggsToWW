...
namespace uhh2examples {
  ...
  */
  class FeasibilityStudyModule_test: public AnalysisModule {
  public:

    explicit FeasibilityStudyModule_test(Context & ctx);
  ...
  FeasibilityStudyModule_test::FeasibilityStudyModule_test(Context & ctx){
  ...
  bool FeasibilityStudyModule_test::process(Event & event) {
  ...
  // make sure the FeasibilityStudyModule_test is found by class name. This is ensured by this macro:
  UHH2_REGISTER_ANALYSIS_MODULE(FeasibilityStudyModule_test)
