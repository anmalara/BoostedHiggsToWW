...
namespace uhh2examples {
  ...
  */
  ...
  private:
    ...
    // Histos
    std::unique_ptr<Hists> h_gen_part_noCuts, h_gen_part;
  ...
  MCTruthMatchingModule::MCTruthMatchingModule(Context & ctx){
    ...
    h_gen_part_noCuts.reset(new GenParticleHiggsHists(ctx, "gen_particles_noCuts"));
    h_gen_part.reset(new GenParticleHiggsHists(ctx, "gen_particles"));
  ...
  bool MCTruthMatchingModule::process(Event & event) {
    ...
    h_jet_angular_matching_H->fill(event);
